...
<body>
	...
	<header>
		<h1> Conheça mais sobre os Exercícios disponíveis e suas recomendações</h1>
	</header>
	<main>
		<div class="item">
			<h2> Peito </h2>
		...
		<div class="item">
			<h2> Costas </h2>
			<p>Exercícios para as costas, como remada, são bons para fortalecer os músculos das costas, incluindo o latíssimo do dorso, trapézio e romboides. Eles também podem ajudar a melhorar a postura e a prevenir lesões nas costa . </p>
		</div>
		<div class="item">
			<h2> Glúteos </h2>
